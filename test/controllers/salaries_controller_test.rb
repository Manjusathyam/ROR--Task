...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference("Salary.count") do
      post salaries_url, params: { salary: { emp_no: @salary.emp_no, from_date: @salary.from_date, salary: @salary.salary, to_date: @salary.to_date } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { emp_no: @salary.emp_no, from_date: @salary.from_date, salary: @salary.salary, to_date: @salary.to_date } }
